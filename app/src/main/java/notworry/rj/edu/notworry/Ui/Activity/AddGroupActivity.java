...
public class AddGroupActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        group_submit.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                addGroup (name, num, name + ".jpg", needNum, intro);
                finish ();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == 2) {
            ...
            doUploadFile (file);
            Glide.with (AddGroupActivity.this).load (file).into (group_pic);
        }
    }
    ...
    public void addGroup(String name, String num, String pic, String needNum, String intro) {
        Gson gson = new Gson ();
        ...
        RequestBody requestBody = new FormBody.Builder ()
                ...
                .build ();
        Request request = new Request.Builder ()
                .url (Constant.BASE_URL + "AddGroup")
                .post (requestBody)
                .build ();
        Call call = okHttpClient.newCall (request);
        call.enqueue (new Callback () {
